...
function tapLove(id) {
  ...
  if (loveTaps.size === 4) {
    Swal.fire({
      ...
      typeWriterEffect(
        `Chúc chị ${userName} của em 1/6 thật vui vẻ như một đứa trẻ, và được em yêu như một nữ hoàng 👑. Dù chị có lớn bao nhiêu thì trong tim em, chị vẫn là công chúa bé bỏng cần được cưng chiều mỗi ngày! 💘`,
        'loveMsg',
        () => {
          const fromTag = document.createElement("div");
          fromTag.id = 'fromTag';
          fromTag.textContent = "From: ANH DUY";
